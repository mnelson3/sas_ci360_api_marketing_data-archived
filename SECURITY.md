...
This repository holds a retained historical reference implementation of a Python client for the SAS Customer Intelligence 360 Marketing Data API. It has been superseded by [`sas-ci360-sol-data`](https://github.com/mnelson3/sas-ci360-sol-data) and is no longer actively developed. Only the code currently deployed on each environment branch is supported — there is no long-term support for older commits.
...
- GitHub's [private vulnerability reporting](https://github.com/mnelson3/sas_ci360_api_marketing_data-archived/security/advisories/new) (enabled on this repo), or
